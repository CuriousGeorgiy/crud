...
function readview.init()
    utils.init_storage_call(OPEN_FUNC_NAME, readview_open_on_storage)
    utils.init_storage_call(CLOSE_FUNC_NAME, readview_close_on_storage)
    utils.init_storage_call(SELECT_FUNC_NAME, select_readview_on_storage)
 end
